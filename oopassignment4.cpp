...
public:
    ...
    friend void display4(int x);     //friend function
};
void display4(int x)
{
    string name, Author;
...
class shape    //to demonstrate INHERITANCE
{
public:
    virtual void area6() = 0;
};
...
public:
    ...
    Complex operator++()             //OPERATOR OVERLOADING
    {
        ++real;
        return real;
    }
